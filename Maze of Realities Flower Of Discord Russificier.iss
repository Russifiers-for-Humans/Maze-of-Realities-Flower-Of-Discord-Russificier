...
; Всегда меняются
#define GameName "Maze of Realities Flower Of Discord"                                          ; Название игры
#define GameNameDash "Maze-of-Realities-Flower-Of-Discord"                                                          ; Название игры без пробелов
#define GameNameEXE "Maze_Of_Realities_Flower_Of_Discord_CE"                                                              ; Название exe файла игры
#define GameVer "1.0"                                                                     ; Версия игры
#define GameAppIdSteam "1889760"                                                             ; Ид игры в стиме
;От ситуации зависит
...
[Setup]
;Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Maze of Realities Flower Of Discord Russificier
AppId={{195C0522-29A4-4852-8CF8-CE9C4F7153FA}
...
[Files]
; Ресурсы
Source: {#Location}\{#GameName}\rus\*; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
